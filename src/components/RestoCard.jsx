...
const RestoCard = ({ data }) => {
  ...
  return (
    <>
      <div className="flex flex-col gap-3 cursor-pointer p-2 m-2">
        <div className="w-80 h-56 card relative rounded-xl">
          <img
            src={IMG_CAROUSEL + cloudinaryImageId}
            alt="res-img"
            className="rounded-xl w-full h-full object-cover"
          />
        </div>
        <div className="ml-3">
          <h2 className="font-bold text-lg tracking-tighter text-color-3">
            {name}
          </h2>
          <div className="font-bold  flex gap-1 text-color-3">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
          ...
          <div className="font-thin text-color-4 tracking-tight text-base">
            {areaName}
          </div>
        </div>
      </div>
